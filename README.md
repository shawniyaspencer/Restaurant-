...
Allows to exit early by using 99.
calculates the subtotal.
Applies a 10% discount if the order is 50$ or more.
Adds 6% tax.
Prints out a receipt showing all the items, discount, tax, quantities, line totals, and the final amount. 
